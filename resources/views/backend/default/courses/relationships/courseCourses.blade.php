...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-courseCourses">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($courses as $key => $course)
                        <tr data-entry-id="{{ $course->id }}">
                            ...
                            <td>
                                @foreach($course->course_features as $key => $item)
                                    <span class="badge badge-info">{{ $item->name }}</span>
                                @endforeach
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-courseCourses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
