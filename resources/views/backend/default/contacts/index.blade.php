...
@can('contact_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('backend.default.csvImport.modal', ['model' => 'Contact', 'route' => 'admin.contacts.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($contact_types as $key => $item)
...
{ data: 'is_preferable', name: 'is_preferable' },
