    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.homes.store", [$home->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('back.home.fields.is_active_helper') }}</span>
            </div>
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_default') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="is_default" value="0">
                    <input class="form-check-input" type="checkbox" name="is_default" id="is_default" value="1" {{ $home->is_default || old('is_default', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="is_default">{{ trans('back.home.fields.is_default') }}</label>
                </div>
                ...
                @endif
                <span class="help-block">{{ trans('back.home.fields.is_default_helper') }}</span>
            </div>
            <div class="form-group">
