<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ \App\Models\Language::where('code', app()->getLocale())->first()->dir }}" class="scroll-smooth">
<head>
    <meta charset="UTF-8" />
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('assets/images/favicon/apple-touch-icon.png') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/tailwind.css') }}" />
