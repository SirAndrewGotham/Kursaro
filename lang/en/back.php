...
return [
    ...
    'page' => [
        ...
        'fields'         => [
            ...
            'id_helper'         => ' ',
            'is_default'        => 'Default',
            'is_default_helper' => 'If you enable this page as a Default, default status will be withdrawn from the previously default version of the page and assigned to this one. Please note, that default page will be set to be Active as well, even if you uncheck Enabled above.',
            'is_active'         => 'Enabled',
            'is_active_helper'  => 'Enable page if you want it to be visible in your site. Disabled pages will fallback to the default page version if requested by a user.',
            'language'          => 'Language',
            'language_helper'   => 'If you don\'t see a language that you need, it means a page version using that language exists. Please pick it up from the list to make changes you want.',
            'translation'       => 'Translation',
            'translation_helper'=> ' ',
            'translations'      => 'Translations',
            'translations_helper'=> ' ',
